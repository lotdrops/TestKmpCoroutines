...
@class SharedPeople, SharedRuntimeQuery<__covariant RowType>, SharedKoin_coreKoin, SharedAppViewModel, SharedExampleDiScope, SharedKoin_coreScope, SharedDiScope, SharedExampleExampleViewModel, SharedDiConstants, SharedDiConstantsDispatchers, SharedKotlinThrowable, SharedCoreViewController, SharedAppDatabaseCompanion, SharedKoin_coreKoinApplication, SharedDependenciesProvider, SharedKoin_coreModule, SharedRuntimeTransacterTransaction, SharedKoin_coreParametersHolder, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreLogger, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKotlinArray<T>, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKotlinUnit, SharedKoin_coreKoinApplicationCompanion, SharedKoin_coreLevel, SharedKoin_coreInstanceFactory<T>, SharedKotlinPair<__covariant A, __covariant B>, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKotlinByteArray, SharedKoin_coreParametersHolderCompanion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreScopeRegistryCompanion, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKotlinByteIterator, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>;

@protocol SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedRuntimeSqlDriver, SharedCoreClearable, SharedCoreFrontDispatchers, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreCoroutineScope, SharedAppDatabaseQueries, SharedAppDatabase, SharedRuntimeSqlDriverSchema, SharedRuntimeSqlCursor, SharedRuntimeQueryListener, SharedRuntimeTransactionCallbacks, SharedRuntimeSqlPreparedStatement, SharedRuntimeCloseable, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKClass, SharedKotlinLazy, SharedKoin_coreScopeCallback, SharedCoreUseCase, SharedCommonsAppPrefsDataSource, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinCoroutineContext, SharedKoin_coreKoinComponent, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinComparable, SharedKotlinIterator, SharedKotlinCoroutineContextKey, SharedKotlinCoroutineContextElement, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable;
...
- (SharedRuntimeQuery<SharedPeople *> *)selectAll __attribute__((swift_name("selectAll()")));
- (SharedRuntimeQuery<id> *)selectAllMapper:(id (^)(NSString *, NSString *))mapper __attribute__((swift_name("selectAll(mapper:)")));
@end;
...
@interface SharedPeople : SharedBase
...
- (SharedPeople *)doCopyName:(NSString *)name craft:(NSString *)craft __attribute__((swift_name("doCopy(name:craft:)")));
...
@property (class, readonly, getter=shared) SharedDiConstants *shared __attribute__((swift_name("shared")));
@end;
...
@property (class, readonly, getter=shared) SharedDiConstantsDispatchers *shared __attribute__((swift_name("shared")));
...
@property (class, readonly) void (^koinLogger)(SharedKoin_coreKoinApplication *) __attribute__((swift_name("koinLogger")));
@end;
...
- (instancetype)initWithDispatchers:(id<SharedCoreFrontDispatchers>)dispatchers getExampleDataUseCase:(id<SharedCoreUseCase>)getExampleDataUseCase testDataSource:(id<SharedCommonsAppPrefsDataSource>)testDataSource __attribute__((swift_name("init(dispatchers:getExampleDataUseCase:testDataSource:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) id<SharedCommonsAppPrefsDataSource> testDataSource __attribute__((swift_name("testDataSource")));
@end;
...
__attribute__((swift_name("CommonsAppPrefsDataSource")))
@protocol SharedCommonsAppPrefsDataSource
@required
- (int32_t)getNumber __attribute__((swift_name("getNumber()")));
- (void)setNumberValue:(int32_t)value __attribute__((swift_name("setNumber(value:)")));
@end;
